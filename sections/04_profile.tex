...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\linewidth]{figures/pictures/three_controlled_user_profiles.png}
    \caption{Three Controlled User Profiles}
    \label{fig:three-controlled-user-profiles}
\end{figure}
