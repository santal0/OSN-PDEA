...
The empirical audit applied the framework to 16 apps and 3 profiles. The protocol targeted 30 steps for each app-profile pair, yielding 1,440 planned observations; the archived result files contain 1,403 analyzable interaction records and 9,821 DPS labels because five trajectories ended before step 30. The results suggest that exposure is unevenly distributed across controlled profiles. High-payment shopping and bargain-hunter trajectories more often encounter Pressure and Interface Interference, consistent with their movement toward checkout, membership, coupon, and promotion-heavy states. Low-payment browsing generally shows lower commercial-pressure exposure but still encounters Forced Action, Nagging, and access-control prompts. Category-level results further suggest that shopping and eating applications concentrate more commitment- or decision-stage pressure, while entertainment and social platforms show stronger interface interference, retention prompts, and access-control moments.
